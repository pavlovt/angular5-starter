...
console.log(this.msg)
    ...
    send(method, url, data, headers, options) {
        ...
        const req = new HttpRequest(method, this.url(url), data, rxOptions);
        // const z = this.http.request(req)
    ...
    url(url) {
        return 'http://aspcapi.azurewebsites.net/api/' + url;
    }
    ...
    handleErrors(res) {
        console.log(res)
        this.msg.error(_.get(res, 'error.Message') || 'Server Error');
